                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="text-center p-20">
                                                <img class="store-logo" src="{{url('assets/images/coupons/coupon_01.jpg')}}" alt="">
                                            </div>
                                            <!-- end media -->
                                        </div>
                                        <!-- end col -->
                        ...
                        <div class="page-pagination text-center mt-30 p-10 panel">
                            <nav>
                                ...
                                <ul class="page-pagination">
                                    @if($page>1)
                                    <li><a class="page-numbers previous" href="{{url($url)}}/{{$page-1}}">Previous</a>
                                    </li>
                                    @endif
                                    @for($i=1;$i<=$count;++$i)
                                    <li><a href="{{url($url)}}/{{$i}}" class="page-numbers
                                        @if($i==$page)
                                             current
                                        @endif
                                        ">{{$i}}</a>
                                    ...
                                    <li><a href="{{url($url)}}/{{$page+1}}" class="page-numbers next">Next</a>
                                    </li>
                                    @endif
                                </ul>
                                <!-- End Page Pagination -->
