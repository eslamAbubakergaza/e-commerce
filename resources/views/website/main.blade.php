                        ...
                        <div class="col-xs-12 col-md-8 col-lg-9">
                            <div class="header-deals-slider owl-slider" data-autoplay="true" data-autoplay-timeout="10000" data-lg-items="1" data-lg-nav="true" data-loop="true" data-md-items="1" data-md-nav="true" data-nav="true" data-nav-speed="false" data-sm-items="1" data-sm-nav="true" data-smart-speed="1000" data-xs-items="1" data-xs-nav="true" data-xxs-items="1" data-xxs-nav="true">
                                ...
                                <div class="deal-single panel item">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="{{URL::asset('website/assets/images/deals/deal_01.jpg')}}">
                                        ...
                                        <div class="deal-about p-20 pos-a bottom-0 left-0">
                                            ...
                                            <h3 class="deal-title mb-10"><a class="color-light color-h-lighter" href="deal_single.blade.php">{{$besteffort->name}}</a></h3>
                                        </div>
                                    </figure>
                                </div>
                                @endforeach
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="deal-single panel">
                                <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="{{URL::asset('website/assets/images/deals/deal_01.jpg')}}">
                                    ...
                                    <div class="deal-store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_01.jpg')}}"></div>
                                </figure>
                                <div class="bg-white pt-20 pl-20 pr-15">
                                    <div class="pr-md-10">
                                       
                                        <h3 class="deal-title mb-10"><a href="deal_single.blade.php">{{$effort->name}}</a></h3>
                                     
                                        <p class="text-muted mb-20">{{$effort->name}}</p>
                                    </div>
                                    <div class="deal-price pos-r mb-15">
                                        <h3 class="price ptb-5 text-right"><span class="price-sale">{{$effort->price}}</span>{{$effort->price}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="latest-coupons-slider owl-slider" data-autoplay="true" data-autoplay-hover-pause="true" data-autoplay-timeout="10000" data-items="1" data-lg-items="4" data-loop="true" data-margin="30" data-md-items="3" data-nav-speed="false" data-sm-items="2" data-smart-speed="1000" data-xs-items="2" data-xxs-items="1">
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20"><img alt="" class="store-logo" src="{{URL::asset('website/assets/images/coupons/coupon_01.jpg')}}"></div><!-- end media -->
                                    </div><!-- end col -->
                                    <div class="col-xs-12">
                ...
                <section class="section stores-area stores-area-v1 ptb-30">
                    ...
                    <div class="popular-stores-slider owl-slider" data-autoplay="true" data-autoplay-timeout="10000" data-items="2" data-lg-items="6" data-loop="true" data-margin="20" data-md-items="5" data-sm-items="3" data-smart-speed="1000" data-xs-items="2" data-xxs-items="2">
                        <div class="store-item t-center">
                            <a class="panel is-block" href="store_single_01.php">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_01.jpg')}}"></div>
                            </div>
                            <h6 class="store-name ptb-10">Amazon</h6></a>
                        </div>
                        <div class="store-item t-center">
                            <a class="panel is-block" href="store_single_01.php">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_02.jpg')}}"></div>
                            </div>
                            <h6 class="store-name ptb-10">Ashford</h6></a>
                        </div>
                        <div class="store-item t-center">
                            <a class="panel is-block" href="store_single_01.php">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_03.jpg')}}"></div>
                            </div>
                            <h6 class="store-name ptb-10">DELL</h6></a>
                        </div>
                        <div class="store-item t-center">
                            <a class="panel is-block" href="store_single_01.php">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_04.jpg')}}"></div>
                            </div>
                            <h6 class="store-name ptb-10">Card Cash</h6></a>
                        </div>
                        <div class="store-item t-center">
                            <a class="panel is-block" href="store_single_01.php">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_05.jpg')}}"></div>
                            </div>
                            <h6 class="store-name ptb-10">Finish Line</h6></a>
                        </div>
                        <div class="store-item t-center">
                            <a class="panel is-block" href="store_single_01.php">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_06.jpg')}}"></div>
                            </div>
                            <h6 class="store-name ptb-10">JC Penny</h6></a>
                        </div>
                        <div class="store-item t-center">
                            <a class="panel is-block" href="store_single_01.php">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_07.jpg')}}"></div>
                            </div>
                            <h6 class="store-name ptb-10">Callaway Golf</h6></a>
                        </div>
                        <div class="store-item t-center">
                            <a class="panel is-block" href="store_single_01.php">
                            <div class="embed-responsive embed-responsive-4by3">
                                <div class="store-logo"><img alt="" src="{{URL::asset('website/assets/images/brands/brand_08.jpg')}}"></div>
                            </div>
                            <h6 class="store-name ptb-10">Car Toys</h6></a>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="newsletter-form">
                        ...
                        <form action="#" method="post">
                            <div class="input-group mb-10">
                                <input class="form-control bg-white" placeholder="Email Address" required="required" type="email"> <span class="input-group-btn"><button class="btn" type="submit"><span class="input-group-btn">Subscribe</span></button></span>
                            </div>
                        </form>
